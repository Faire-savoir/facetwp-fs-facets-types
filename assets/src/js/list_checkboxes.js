(function ($) {
    ...
    $().on('click', '.facetwp-type-fs_list_checkboxes .facetwp-expand', function(e) {
    ...
    $().on('click', '.facetwp-type-fs_list_checkboxes .facetwp-checkbox:not(.disabled)', function() {
        var $cb = $(this);
    ...
    $().on('click', '.facetwp-type-fs_list_checkboxes .facetwp-toggle', function() {
    ...
    $().on('facetwp-loaded', function() {
        $('.facetwp-type-fs_list_checkboxes .facetwp-overflow').each(function() {
        ...
        $('.facetwp-type-fs_list_checkboxes').each(function() {
            var $facet = $(this);
