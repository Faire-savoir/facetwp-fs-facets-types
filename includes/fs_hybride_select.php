...
class FacetWP_FS_Hybride_Select extends FacetWP_Facet
{
    ...
    function __construct() {
        $this->label = __( 'FS - Hybride Select', 'fwp' );
    ...
    function front_scripts() {
        $front_script_checboxes = FACETWP_FS_FACETS_TYPES_PLUGIN_URL . 'assets/js/list_checkboxes.js';
        $front_script_hybride = FACETWP_FS_FACETS_TYPES_PLUGIN_URL . 'assets/js/fs_hybride_select.js';
        
        FWP()->display->json['expand'] = '[+]';
        FWP()->display->json['collapse'] = '[-]';
        
        FWP()->display->assets['list_checkboxes.js'] = [ $front_script_checboxes, FACETWP_FS_FACETS_TYPES_PLUGIN_VERSION ];
        FWP()->display->assets['fs-hybride-select.js'] = [ $front_script_hybride, FACETWP_FS_FACETS_TYPES_PLUGIN_VERSION ];
