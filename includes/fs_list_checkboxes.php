...
class FacetWP_FS_List_Checkboxes extends FacetWP_Facet
{
    ...
    function __construct() {
        $this->label = __( 'FS - List Checkboxes', 'fwp' );
    ...
    function front_scripts() {
        ...
        $front_script = FACETWP_FS_FACETS_TYPES_PLUGIN_URL . 'assets/src/js/list_checkboxes.js';
        FWP()->display->assets['list_checkboxes.js'] = [ $front_script, FACETWP_FS_FACETS_TYPES_PLUGIN_VERSION ];
